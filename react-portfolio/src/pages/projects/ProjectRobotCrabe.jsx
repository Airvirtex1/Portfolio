    ...
    <div className="min-h-screen bg-surface-base text-text-primary transition-colors duration-300">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-32 pb-16">
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          ...
          <span className="bg-surface-overlay px-4 py-2 rounded-lg text-sm">Robotique</span>
          <span className="bg-surface-overlay px-4 py-2 rounded-lg text-sm">HTML/Web</span>
          <span className="bg-surface-overlay px-4 py-2 rounded-lg text-sm">Servomoteurs</span>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-16">
        <div className="bg-gradient-to-br from-orange-950/30 to-surface-raised rounded-2xl p-8 md:p-12 border border-orange-900/20">
          <h2 className="font-display text-3xl font-semibold mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-surface-base/50 rounded-xl p-6">
              ...
              <div className="text-sm text-text-secondary">{t("project.crabe.integration.meca.text")}</div>
            </div>
            <div className="bg-surface-base/50 rounded-xl p-6">
              <div className="text-orange-400 font-semibold mb-3">{t("project.crabe.integration.elec.title")}</div>
              <div className="text-sm text-text-secondary">{t("project.crabe.integration.elec.text")}</div>
            </div>
            <div className="bg-surface-base/50 rounded-xl p-6">
              <div className="text-orange-400 font-semibold mb-3">{t("project.crabe.integration.soft.title")}</div>
              <div className="text-sm text-text-secondary">{t("project.crabe.integration.soft.text")}</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="bg-gradient-to-br from-surface-raised to-surface-overlay border border-border-subtle rounded-2xl p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <div className="bg-surface-base/50 rounded-xl p-6 text-center">
              ...
              <div className="text-sm text-text-secondary">{t("project.crabe.skills.badge1.text")}</div>
            </div>
            <div className="bg-surface-base/50 rounded-xl p-6 text-center">
              <div className="text-2xl mb-2">📡</div>
              <div className="font-semibold mb-1">{t("project.crabe.skills.badge2.title")}</div>
              <div className="text-sm text-text-secondary">{t("project.crabe.skills.badge2.text")}</div>
            </div>
            <div className="bg-surface-base/50 rounded-xl p-6 text-center">
              <div className="text-2xl mb-2">🔧</div>
              <div className="font-semibold mb-1">{t("project.crabe.skills.badge3.title")}</div>
              <div className="text-sm text-text-secondary">{t("project.crabe.skills.badge3.text")}</div>
            </div>
          </div>
        </div>
      </section>
