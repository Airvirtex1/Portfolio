    ...
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-32 pb-16">
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          ...
          <span className="bg-neutral-800 px-4 py-2 rounded-lg text-sm">PID</span>
          <span className="bg-neutral-800 px-4 py-2 rounded-lg text-sm">Électronique</span>
          <span className="bg-neutral-800 px-4 py-2 rounded-lg text-sm">Asservissement</span>
          <span className="bg-neutral-800 px-4 py-2 rounded-lg text-sm">Mécatronique</span>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-16">
        <div className="bg-gradient-to-br from-blue-950/30 to-neutral-900 rounded-2xl p-8 md:p-12 border border-blue-900/20">
          <h2 className="text-3xl font-semibold mb-6">
          ...
          <div className="space-y-4 text-neutral-400 leading-relaxed">
            ...
            <div className="grid md:grid-cols-3 gap-4 mt-6">
              <div className="bg-neutral-950/50 rounded-xl p-4">
                ...
                <div className="text-sm text-neutral-400">{t("project.asservissement.pid.proportional")}</div>
              </div>
              <div className="bg-neutral-950/50 rounded-xl p-4">
                <div className="text-blue-400 font-semibold mb-2">Intégral (I)</div>
                <div className="text-sm text-neutral-400">{t("project.asservissement.pid.integral")}</div>
              </div>
              <div className="bg-neutral-950/50 rounded-xl p-4">
                <div className="text-blue-400 font-semibold mb-2">Dérivé (D)</div>
                <div className="text-sm text-neutral-400">{t("project.asservissement.pid.derivative")}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-2xl p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <div className="bg-neutral-950/50 rounded-xl p-6 text-center">
              ...
              <div className="text-sm text-neutral-400">{t("project.asservissement.skills.badge1.text")}</div>
            </div>
            <div className="bg-neutral-950/50 rounded-xl p-6 text-center">
              <div className="text-2xl mb-2">📊</div>
              <div className="font-semibold mb-1">{t("project.asservissement.skills.badge2.title")}</div>
              <div className="text-sm text-neutral-400">{t("project.asservissement.skills.badge2.text")}</div>
            </div>
            <div className="bg-neutral-950/50 rounded-xl p-6 text-center">
              <div className="text-2xl mb-2">🔧</div>
              <div className="font-semibold mb-1">{t("project.asservissement.skills.badge3.title")}</div>
              <div className="text-sm text-neutral-400">{t("project.asservissement.skills.badge3.text")}</div>
            </div>
          </div>
        </div>
      </section>
