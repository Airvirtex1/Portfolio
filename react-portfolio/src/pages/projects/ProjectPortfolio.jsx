    ...
    <div className="min-h-screen bg-surface-base text-text-primary transition-colors duration-300">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-32 pb-16">
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          <span className="bg-surface-overlay px-4 py-2 rounded-lg text-sm">React</span>
          <span className="bg-surface-overlay px-4 py-2 rounded-lg text-sm">Tailwind CSS</span>
          <span className="bg-surface-overlay px-4 py-2 rounded-lg text-sm">React Router</span>
          <span className="bg-surface-overlay px-4 py-2 rounded-lg text-sm">i18next</span>
        </div>
        ...
        <div className="bg-gradient-to-br from-surface-raised to-surface-overlay border border-border-subtle rounded-2xl p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <div className="text-center">
              <div className="font-display text-3xl font-bold mb-2">3</div>
              <div className="text-sm text-text-secondary">{t("project.portfolio.results.languages")}</div>
            </div>
            <div className="text-center">
              <div className="font-display text-3xl font-bold mb-2">100%</div>
              <div className="text-sm text-text-secondary">{t("project.portfolio.results.responsive")}</div>
            </div>
            <div className="text-center">
              <div className="font-display text-3xl font-bold mb-2">Fast</div>
              <div className="text-sm text-text-secondary">{t("project.portfolio.results.performance")}</div>
            </div>
          </div>
        </div>
      </section>
